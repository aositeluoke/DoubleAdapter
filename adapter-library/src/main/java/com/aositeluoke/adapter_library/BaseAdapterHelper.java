...
public class BaseAdapterHelper {
     ...
     * @param groupPosition
     */
    protected BaseAdapterHelper(Context context, ViewGroup parent, int layoutId, int groupPosition) {
...
//    }
    ...
    public static BaseAdapterHelper get(Context context, View convertView, ViewGroup parent, int layoutId,
                                        int groupPosition) {
        if (convertView == null) {
            return new BaseAdapterHelper(context, parent, layoutId, groupPosition);
        }

        // Retrieve the existing helper and update its childPosition
        ...
        existingHelper.groupPosition = groupPosition;
...
//    }
    ...
    /**
     * Retrieve the overall childPosition of the data in the list.
     *
     * @throws IllegalArgumentException If the childPosition hasn't been set at the construction of the this helper.
     */
    public int getChildPosition() {
        if (childPosition == -1)
            throw new IllegalStateException("Use BaseAdapterHelper constructor "
                    + "with childPosition if you need to retrieve the childPosition.");
    ...
    public int getGroupPosition() {
        if (groupPosition == -1)
            throw new IllegalStateException("Use BaseAdapterHelper constructor "
                    + "with groupPosition if you need to retrieve the groupPosition.");
